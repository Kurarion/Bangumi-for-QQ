...
[up指令\<仅限魔法少女使用\>](#up指令仅限魔法少女使用)

[S系列指令](#s系列指令)

[search/se指令](#searchse指令)

[subject/su指令](#subjectsu指令)

[save/sa指令\<仅限魔法少女使用\>](#savesa指令仅限魔法少女使用)

[C系列指令](#c系列指令)

[collect/co指令\<仅限魔法少女使用\>](#collectco指令仅限魔法少女使用)

[B系列指令](#b系列指令)

[bangumi/bgm指令](#bangumibgm指令)

[L系列指令](#l系列指令)

[list/li指令\<仅限魔法少女使用\>](#listli指令仅限魔法少女使用)
